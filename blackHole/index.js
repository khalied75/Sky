...
//         // بيانات البحث
//         const searchData = [
//             { type: 'ثقب أسود', name: 'القوس A*', url: '#sagittarius' },
//             { type: 'ثقب أسود', name: 'M87', url: '#m87' },
//             { type: 'ثقب أسود', name: 'TON 618', url: '#ton618' },
//             { type: 'ثقب أسود', name: 'Cygnus X-1', url: '#cygnus' },
//             { type: 'قانون', name: 'سرعة الإفلات', url: '#escape' },
//             { type: 'قانون', name: 'شفارتزشيلد', url: '#schwarzschild' },
//             { type: 'قانون', name: 'إشعاع هوكينغ', url: '#hawking' },
//             { type: 'قانون', name: 'مبدأ الريبة', url: '#heisenberg' },
//         ];
