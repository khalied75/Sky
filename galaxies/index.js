...
const searchData = [
    ...
    // المجرات
    { type: 'مجرة', name: 'درب التبانة', url: 'index.html' },
    { type: 'مجرة', name: 'أندروميدا', url: 'index.html' },
    { type: 'مجرة', name: 'المثلث', url: 'index.html' },
    { type: 'مجرة', name: 'الدوامة', url: 'index.html' },
    { type: 'مجرة', name: 'السومبريرو', url: 'index.html' },
    { type: 'مجرة', name: 'ميسييه 87', url: 'index.html' },
];
