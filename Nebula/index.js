...
const searchData = [
    ...
    // السدم
    { type: 'سديم', name: 'سديم الجبار', url: 'index.html' },
    { type: 'سديم', name: 'سديم السرطان', url: 'index.html' },
    { type: 'سديم', name: 'سديم النسر', url: 'index.html' },
    { type: 'سديم', name: 'سديم الحلقة', url: 'index.html' },
    { type: 'سديم', name: 'سديم رأس الحصان', url: 'index.html' },
